...
private:
    ...
    void removeHelper(Node *parent, Node *node);
    Node *searchHelper(const string &key, Node *node) const;
    Node *getParentNode(Node *curr) const;
    Node *getParentNodeHelper(Node *parent, Node *curr) const;
    
    void preOrderHelper(Node *node) const;
    void postOrderHelper(Node *node) const;
    void inOrderHelper(Node *node) const;

    int subtreeHeightHelper(Node *node) const;
    int heightHelper(const string &key, Node *node, int heightCount) const;

    Node *largestHelper(Node *node) const;
    Node *smallestHelper(Node *node) const;
};

...
private:
   ...
   /*Helper function to delete the tree, used for the deconstructor*/
   void deleteTree(TreeNode *currNode);
   /*Helper function to copy all the items in the tree to another tree*/
   TreeNode *copyTree(const TreeNode *currNode);
   /*Helper function to build the tree*/
   TreeNode *buildTreeHelper(string &eq, char &key);
};
#endif